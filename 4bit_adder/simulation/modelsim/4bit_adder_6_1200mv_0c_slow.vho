...
-- sum	=>  Location: PIN_L11,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \hd2|cout~combout\ : std_logic;
SIGNAL \hd2|sum~combout\ : std_logic;
...
\hd2|cout\ : cycloneiv_lcell_comb
-- Equation(s):
-- \hd2|cout~combout\ = (\cin~input_o\ & (\b~input_o\ $ (\a~input_o\)))
...
PORT MAP (
	...
	datac => \b~input_o\,
	datad => \a~input_o\,
	combout => \hd2|cout~combout\);

-- Location: LCCOMB_X8_Y1_N2
\hd2|sum\ : cycloneiv_lcell_comb
-- Equation(s):
-- \hd2|sum~combout\ = \cin~input_o\ $ (\b~input_o\ $ (\a~input_o\))
